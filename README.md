...
local plr = game.Players.LocalPlayer local chr = plr.Character chr.HumanoidRootPart.CFrame = CFrame.new(-574, 9, -517) end)
...
tab.newButton("soco scrip", "permite quw você dê socos Sem equipar nenhum item basta executar equipar o combate se reiniciar e quando voltar não equipe nenhum item apenas use o botao "soco" e mesmo se parar e começar  a correr denovo ainda vai conseguir socar com o botão basta não equipar nenhum item", function()
